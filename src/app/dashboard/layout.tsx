    ...
    <div className="mx-auto flex max-w-6xl gap-8 px-4 py-8">
      ...
      <aside className="hidden w-44 shrink-0 sm:block">
        <nav className="sticky top-24 space-y-1">
          <p className="mb-3 text-xs font-semibold text-muted-fg/60 uppercase tracking-wider px-3">
            管理中心
          </p>
          {NAV_ITEMS.map((item) => {
      ...
      {/* Mobile bottom tabs */}
      <div className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-border/60 bg-surface/95 backdrop-blur-xl sm:hidden">
        {NAV_ITEMS.map((item) => {
          const isActive = pathname === item.href;
          return (
            <Link
